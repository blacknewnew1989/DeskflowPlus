...
void DevicesDock::updateText()
{
  ...
  m_configureInputAction->setText(i18n::translate(Text::DevicesActionConfigureInput));
...
void DevicesDock::manageManualAddresses()
{
  ...
  auto *hostLabel = new QLabel(i18n::translate(Text::DevicesManualAddressHost), &dialog);
  hostLabel->setObjectName(QStringLiteral("relaydeskManualAddressHostLabel"));
  ...
  host->setAccessibleName(hostLabel->text());
  hostLabel->setBuddy(host);
  layout->addWidget(host);
  auto *ports = new QHBoxLayout();
  auto *inputPortColumn = new QVBoxLayout();
  auto *inputPortLabel = new QLabel(i18n::translate(Text::DevicesManualAddressInputPort), &dialog);
  inputPortLabel->setObjectName(QStringLiteral("relaydeskManualAddressInputPortLabel"));
  inputPortColumn->addWidget(inputPortLabel);
  ...
  inputPort->setAccessibleName(inputPortLabel->text());
  inputPortLabel->setBuddy(inputPort);
  inputPortColumn->addWidget(inputPort);
  auto *filePortColumn = new QVBoxLayout();
  auto *filePortLabel = new QLabel(i18n::translate(Text::DevicesManualAddressFilePort), &dialog);
  filePortLabel->setObjectName(QStringLiteral("relaydeskManualAddressFilePortLabel"));
  filePortColumn->addWidget(filePortLabel);
  ...
  filePort->setAccessibleName(filePortLabel->text());
  filePortLabel->setBuddy(filePort);
  filePortColumn->addWidget(filePort);
  ports->addLayout(inputPortColumn);
  ports->addLayout(filePortColumn);
