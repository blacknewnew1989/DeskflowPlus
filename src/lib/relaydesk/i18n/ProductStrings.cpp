...
constexpr std::array<Entry, static_cast<std::size_t>(Text::Count)> kEntries{{
    ...
    {Text::DevicesActionRevokeTrust, QT_TRANSLATE_NOOP("RelayDesk", "devices.action.revoke_trust"),
     "Revoke trust"},
    {Text::DevicesRevokeTrustTitle, QT_TRANSLATE_NOOP("RelayDesk", "devices.revoke_trust.title"),
     "Revoke trust?"},
    {Text::DevicesRevokeTrustConfirmation,
     QT_TRANSLATE_NOOP("RelayDesk", "devices.revoke_trust.confirmation"),
    ...
    {Text::DevicesManualAddressManage, QT_TRANSLATE_NOOP("RelayDesk", "devices.manual_address.manage"),
     "Add address"},
    ...
    {Text::PermissionsAffectedMacAccessibility,
     QT_TRANSLATE_NOOP("RelayDesk", "permissions.affected.macos_accessibility"),
     "Input control on this Mac"},
    {Text::PermissionsAffectedMacInputMonitoring,
     QT_TRANSLATE_NOOP("RelayDesk", "permissions.affected.macos_input_monitoring"),
     "Sharing input from this Mac"},
    ...
    {Text::TransferConflictTitle, QT_TRANSLATE_NOOP("RelayDesk", "transfer.conflict.title"),
     "File already exists"},
    {Text::TransferConflictOverwrite, QT_TRANSLATE_NOOP("RelayDesk", "transfer.conflict.overwrite"), "Replace"},
    {Text::TransferConflictAutoRename, QT_TRANSLATE_NOOP("RelayDesk", "transfer.conflict.auto_rename"),
     "Keep both"},
