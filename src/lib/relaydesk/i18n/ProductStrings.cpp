...
constexpr std::array<Entry, static_cast<std::size_t>(Text::Count)> kEntries{{
    ...
    {Text::TransferHistoryStartedLabel, QT_TRANSLATE_NOOP("RelayDesk", "transfer.history.started_label"),
     "Started"},
    {Text::TransferHistoryFinishedLabel, QT_TRANSLATE_NOOP("RelayDesk", "transfer.history.finished_label"),
     "Finished"},
    {Text::TransferHistoryDurationLabel, QT_TRANSLATE_NOOP("RelayDesk", "transfer.history.duration_label"),
     "Duration"},
    {Text::TransferHistoryErrorLabel, QT_TRANSLATE_NOOP("RelayDesk", "transfer.history.error_label"), "Error"},
    {Text::TransferHistoryItems, QT_TRANSLATE_N_NOOP("RelayDesk", "transfer.history.items"), "%1 item",
     "%1 items"},
    {Text::TransferHistoryDurationSeconds,
     QT_TRANSLATE_N_NOOP("RelayDesk", "transfer.history.duration_seconds"), "%1 second", "%1 seconds"},
    {Text::TransferHistoryDurationMinutes,
     QT_TRANSLATE_N_NOOP("RelayDesk", "transfer.history.duration_minutes"), "%1 minute", "%1 minutes"},
    {Text::TransferHistoryDurationHours, QT_TRANSLATE_N_NOOP("RelayDesk", "transfer.history.duration_hours"),
     "%1 hour", "%1 hours"},
    ...
    {Text::TransferAccessibleSummary, QT_TRANSLATE_NOOP("RelayDesk", "transfer.accessible.summary"),
     "%1, %2, %3, %4, %5"},
    {Text::TransferNotificationCompleted,
     QT_TRANSLATE_NOOP("RelayDesk", "transfer.notification.completed"), "Transfer completed"},
